...
if __name__ == '__main__':
    ...
    if args.type == 'dvae':
        ...
        dvae.compile()
        dvae.fit(generator, epochs=epochs, steps_per_epoch=spe)
        ...
        cd_dvae.compile()
        cd_dvae.fit(generator, epochs=epochs, steps_per_epoch=spe)
        ...
        vaece.fit(generator, epochs=epochs, steps_per_epoch=spe)
        ...
        gvae.fit(generator, epochs=epochs, steps_per_epoch=spe)
        ...
        lvae.fit(generator, epochs=epochs, steps_per_epoch=spe)
        ...
        ada_gvae.fit(generator, epochs=epochs, steps_per_epoch=spe)
