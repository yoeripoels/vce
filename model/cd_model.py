...
class CD_DVAE(DVAE, CD):
    ...
    _name_loss = ['rec', 'kl_y', 'kl_x', 'class', 'disc']
    ...
    def __init__(self, input_shape, dim_y, dim_x, num_class=10,
        ...
        self.discriminator = Classifier(dim_y, num_class=2)
    ...
    def forward_loss(self, batch):
        ...
        disc_pred = self.discriminator(z_dif)
    ...
    def train_step(self, batch):
        ...
        with tf.GradientTape() as tape:
            (l['rec'], l['kl_y'], l['kl_x'], l['class'], l['disc']), \
        ...
        train_variables = [*self.encoder_y.trainable_variables, *self.encoder_x.trainable_variables,
                           ...
                           *self.classifier_x.trainable_variables, *self.discriminator.trainable_variables]
